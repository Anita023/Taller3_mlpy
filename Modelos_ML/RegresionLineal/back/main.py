...
app = FastAPI(title="API de PredicciÃ³n de Precios de Viviendas",description="Esta API predice el precio de una vivienda en funcion de la superficie en metros cuadrados utilizando un modelo de regresiÃ³n lineal previamente entrenado.", version="1.0.0")
...
def predict_price(data : housem2):
    ...
    # Realizar la predicciÃ³n utilizando el modelo cargado
    prediction = model.predict([[data.area_m2]]) [0]
    
    return {
        "area_m2": data.area_m2,
        "predicted_price": float(prediction, 2)
    }
